...
inline bool NucleonProfile::participate(Nucleon& A, Nucleon& B) const {
  ...
  double Kf = field_generator.calculate_fluct_norm(A.fi(), A.fj(), B.fi(), B.fj(), dx, dy)
				* field_generator.calculate_proton_norm(A.fi(), A.fj())
				* field_generator.calculate_proton_norm(B.fi(), B.fj());
	//std::cout << field_generator.calculate_proton_norm(A.fi(), A.fj()) << " " << field_generator.calculate_proton_norm(B.fi(), B.fj()) << std::endl;
